...
<head>
    ...
    <title>Student Registration - BUEPS</title>
        ...
        <div class="registration-container">
            <div class="reg-card">
                <div class="reg-header">
                    <a href="{{ route('home') }}" class="back-link" style="display: inline-flex; align-items: center; gap: 8px; color: #666; text-decoration: none; margin-bottom: 20px; font-size: 14px;">
